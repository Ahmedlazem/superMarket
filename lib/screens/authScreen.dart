      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/image/supergreen.png'),
            fit: BoxFit.fill,
          ),
        ),
    ...
    try {
      if (_authMode == AuthMode.Login) {
        ...
        Navigator.of(context)
            .pushNamed(SetLocation.routeName);
      }
            ...
            child: Column(
              children: <Widget>[
                ...
                if (_authMode == AuthMode.Signup)
                 ...
                 // obscureText: true,
                  validator: (value) {
                    ...
                    if (value.length < 4) {
                      return 'enter more than 4 letters';
                    }
                    return null;
                  },
                  onSaved: (value) {
                ...
                if (_authMode == AuthMode.Signup)
                  ...
                  TextFormField(
                  enabled: _authMode == AuthMode.Signup,
                  decoration: InputDecoration(labelText: 'Your Mobile No'),
                 // obscureText: true,
                  validator: (value) {
                    if (value.isEmpty) {
                    ...
                    if (value.length < 10) {
                      return 'enter more than 4 Digits';
                    }
                    return null;
                  },
                  onSaved: (value) {
